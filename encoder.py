...
def main() -> int:
    parser = argparse.ArgumentParser(description="Encode one or more stored originals into proxy files.")
    parser.add_argument("paths", nargs="*", help="Source original files to encode.")
    ...
    for raw_path in args.paths:
        result = encoder.encode(raw_path)
